...
import { traerCliente } from 'API/cliente';
import { updateClienteApi } from 'API/cliente';
...
export default function EditarCliente() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (formValue) => {
            ...
            const response = await updateClienteApi(formValue, auth, busqueda)
    ...
    const CambiarEstado = async () => {
        ...
        const response = await traerCliente(proceso, valor, auth)
        console.log(response)
