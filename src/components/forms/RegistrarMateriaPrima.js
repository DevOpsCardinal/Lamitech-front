...
import { createMateriaPrimaApi } from 'API/materiaPrima';
...
export default function RegistrarMateriaPrima() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (formValue) => {
      const response = await createMateriaPrimaApi(formValue, auth)
