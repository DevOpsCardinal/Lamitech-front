...
import { updateProveedor, traerProveedor } from "API/proveedor";
...
import {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (formValue) => {
      ...
      const response = await updateProveedor(formValue, auth, busqueda)
  ...
  const CambiarEstado = async()=>{
    ...
    const response = await traerProveedor(proceso,valor, auth);
