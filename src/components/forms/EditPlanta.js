...
import { traerPlanta, updatePlanta } from "API/planta";
  ...
  export default function EditarPlanta(){
    ...
    const formik = useFormik({
        ...
        onSubmit: async (formValue) => {
          const response = await updatePlanta(formValue, auth, busqueda)
      ...
      const response = await traerPlanta(proceso,valor, auth)
          ...
          <tr >
            <td>
              ...
              <Form onSubmit={formik.handleSubmit}>
                <h4 style={{ color: '#fff' }}>Actualizar Planta</h4>
