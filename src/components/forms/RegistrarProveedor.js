...
import { crearProveedorApi } from 'API/proveedor';
...
export default function RegistrarProveedor() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            nit: Yup.string().required(true),
            nombre: Yup.string().required(true),
            direccion: Yup.string().required(true),
            telefono: Yup.string().required(true),//Yup.number()
            observaciones: Yup.string().required(false),
        }),
        onSubmit: async (formValue) => {
            const response = await crearProveedorApi(formValue, auth)
            ...
            <tr >
                <td>
                    ...
                    <Form onSubmit={formik.handleSubmit}>
                        <h4 style={{ color: '#fff' }}>Registrar Proveedor</h4>
